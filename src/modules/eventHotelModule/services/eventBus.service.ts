...
export class EventBusService {
    constructor(
        @InjectModel('EventBus') private busModel: Model<IEventBus>,
    ) { }
    ...
    async update(id: string, updateBusDto: UpdateEventBusDto): Promise<IEventBus> {
    ...
    async checkBusComplete(id: string): Promise<{ complete: boolean; missing: string[] }> {
